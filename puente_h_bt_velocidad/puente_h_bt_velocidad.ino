...
ARDUINO   L293D(Puente H)        
  ...
  La fuente de alimentacion de los Motores se conecta a tierra y999
...
int x_adel, x_atra, x_izqu, x_dere, x_vel = 0;
...
Serial.println(x_atra);
                    ...
                    if( req.indexOf("S")!= -1 ) { // example: if cmd is "servo1 1500"
                          x_adel = 0;
                          x_atra = 0;
                          Serial.println("stop");
                        }
                    ...
                    if( req.indexOf("C")!= -1 ) { // example: if cmd is "servo1 1500"
                          x_dere = 0;
                          x_izqu = 0;
